...
[<TypeProvider>]
type public RefSeqProvider(config: TypeProviderConfig) as this =
    ...
    let assemblyProvidedType =
        ProvidedTypeDefinition(thisAssembly, namespaceName, "RefSeqProvider", Some typeof<obj>)
